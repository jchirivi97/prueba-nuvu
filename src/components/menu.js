                ...
                <ul className="nav">
                    <li className="nav-item p-1">
                        <a className="nav-link active" href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door svgActive" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item p-1">
                        <a className="nav-link" href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-list-ul svgInactive" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item p-1">
                        <a className="nav-link" style={{marginTop:"-2.5rem"}} href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-plus-circle-fill svgAhorro" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item p-1">
                        <a className="nav-link" href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-circle svgInactive" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item p-1">
                        <a className="nav-link" href="#">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-three-dots svgInactive" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
